...
import button1 from '@components/landings/elements/button1.vue'
import button2 from '@components/landings/elements/button2.vue'
...
Vuse.component(button1)
Vuse.component(button2)

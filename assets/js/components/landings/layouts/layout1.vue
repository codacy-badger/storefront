<template>
    <section
            class="layout" v-styler:section="$sectionData.classes" v-bind:class="$sectionData.classes">
        <div class="layout__wrap">
            <div class="layout__content">
                <div class="panel">
                    <div class="panel__wrap">
                        <div class="panel__section">
                            <uploader class="panel__logo-img" path="$sectionData.logos[0].path"
                                      :title="$sectionData.logos[0].alt" :alt="$sectionData.logos[0].alt"></uploader>
                        </div>
                        <div class="panel__section">
                            <div class="panel__title" v-styler="$sectionData.slogan[0].text"
                                 v-text="$sectionData.slogan[0].title"></div>
                            <div class="panel__title panel__title_big" v-styler="$sectionData.slogan[1].text"
                                 v-text="$sectionData.slogan[1].title"></div>
                        </div>
                        <div class="panel__section">
                            <ul class="panel__features">
                                <div class="panel__feature" v-for="(item, index) in $sectionData.features">
                                    <span v-text="item.title" v-styler="item.text"></span>
                                </div>
                            </ul>
                        </div>
                        <div class="panel__section panel__section_grow">
                            <span class="b-button" @click.prevent="onClick" :class="$sectionData.buttons[0].classes"
                                  :href="$sectionData.buttons[0].href" v-html="$sectionData.buttons[0].text"
                        ...
                        <div class="panel__section">
                            <footer class="footer">
                                <div class="footer__group">
                                    <uploader class="footer__el footer__el_gamenet" path="$sectionData.logos[1].path"
                                              :title="$sectionData.logos[1].alt"
                                ...
                                <div class="footer__group footer__group_light">
                                      <span v-for="item in $sectionData.links">
                                          ...
                                          <a @click.prevent="openLink(item)" :class="item.classes"
                                             class="footer__el footer__el_link" :href="item.href" v-html="item.text"
                                             v-styler="item">
                                          </a>
                                      </span>
                                </div>

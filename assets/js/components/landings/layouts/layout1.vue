                  ...
                  <div class="b-layout-1__panel">
                      <div class="b-layout-1__panel__wrap">
                          <div class="b-layout-1__panel__section">
                              <uploader class="b-layout-1__panel__logo-img" path="$sectionData.logos[0].path" :title="$sectionData.logos[0].alt" :alt="$sectionData.logos[0].alt"></uploader>
                          </div>
                          <div class="b-layout-1__panel__section">
                              <div class="b-layout-1__panel__title" v-styler="$sectionData.slogan[0].text" v-text="$sectionData.slogan[0].title"></div>
                              <div class="b-layout-1__panel__title panel__title_big" v-styler="$sectionData.slogan[1].text" v-text="$sectionData.slogan[1].title"></div>
                          </div>
                          ...
                          <div class="b-layout-1__panel__section b-layout-1__panel__section_grow">
                            <span class="b-layout-1__b-button" @click.prevent="onClick" :class="$sectionData.buttons[0].classes" :href="$sectionData.buttons[0].href" v-html="$sectionData.buttons[0].text" v-styler="$sectionData.buttons[0].button">
                          ...
                          <div class="b-layout-1__panel__section">
                              <footer class="b-layout-1__footer">
                                  <div class="b-layout-1__footer__group">
                                      <uploader class="b-layout-1__footer__el b-layout-1__footer__el_logo" path="$sectionData.logos[1].path" :title="$sectionData.logos[1].alt" :alt="$sectionData.logos[1].alt"></uploader>
                                  ...
                                  <div class="b-layout-1__footer__group b-layout-1__footer__group_light">
                                      <span v-for="item in $sectionData.links">
                                          ...
                                          <a @click.prevent="openLink(item)" :class="item.classes"
                                                class="b-layout-1__footer__el b-layout-1__footer__el_link" :href="item.href" v-html="item.text"  v-styler="item">
                                          </a>
                                      </span>
                                  </div>
                              </footer>
